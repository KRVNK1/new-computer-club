...
<body>
    <div class="main-container">
        <header class="header">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/63e65463a29922de6ccaf410bc4f03dde7a9aa076e70206db295687416b7d5bf?placeholderIfAbsent=true"
                class="background-image" alt="Background">
            <div class="header-content">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/47c26c2f478f36f2704b1821a48e66dda840f816ed9dec7559061de0f5b09d40?placeholderIfAbsent=true"
        ...
        <section class="hero-section">
            ...
            <div class="hero-content">
                ...
                <div class="hero-image-container">
                    <img src="./img/dura.png" alt="">
                </div>
            </div>
        </section>

        <section class="gallery-section">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/ecd633dabf5dd354a5086b9d413992fb2cf8ab79d04785b78d607167508fc645?placeholderIfAbsent=true"
                class="background-image" alt="Gallery Background">
            <div class="gallery-content" data-el="div-2">
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/1cfa0460d74cc7d878ff224b283756afa5ff17ee6cc155a7cca48ad26bee37c0?placeholderIfAbsent=true"
                            class="gallery-image" alt="Gaming Setup 1">
                    </div>
                    <div class="gallery-item">
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/b6dc7274a16ce59d83beb1980b3e59cdff1feecd867bb62fb6c952bf24f0490a?placeholderIfAbsent=true"
                            class="gallery-image" alt="Gaming Setup 2">
                    </div>
                    <div class="gallery-item">
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/9df86e7194bf4ecff9342e2a78c522ca6665371cc64661bde819d5c000b16595?placeholderIfAbsent=true"
        ...
        <section class="map-section" id="map">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/0dbad5c0fb338286684e67f598ea770044f330df417a19d7371768f515f7d3ec?placeholderIfAbsent=true"
        ...
        <footer class="footer">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/11edc48478e32c12a30d8ba1e231e3d0afc8600e58df02a539ba7956c5d439d5?placeholderIfAbsent=true"
                class="background-image" alt="Footer Background">
            <div class="footer-content">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/7106b7d9c84ef4cb2b57f084f9d536f02ee9f920b186e917e5b6dc15291a42c0?placeholderIfAbsent=true"
